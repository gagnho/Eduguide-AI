...
def nlp_answer(question):
    ...
    if not responses:
        responses = ["That is a cool question , you would never ask that if you never studied anything. If you are asking this question that means you are hardworking. I hope the best for you. Do your best and find this out yourself"]
    return responses
